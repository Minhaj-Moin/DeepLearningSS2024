...
class TestFullyConnected2(unittest.TestCase):
    ...
    def test_trainable(self):
        ...
        self.assertTrue(
            layer.trainable,
            "Possible reason: FullyConnected Layer doesn't inherit the Base Layer and/or"
    ...
    def test_forward_size(self):
        ...
        self.assertEqual(
            ...
            self.output_size,
            "Possible reason: Weights have the wrong shape or"
            "the formula isn't implemented correctly.",
        )
        self.assertEqual(
            output_tensor.shape[0],
            self.batch_size,
            "Possible reason: Shape of the input_tensor is"
    ...
    def test_backward_size(self):
        ...
        self.assertEqual(
            ...
            self.input_size,
            "Possible reason: Bias column has not been removed,"
            "the weights have not been transposed, or the formula"
            "is not implemented correctly.",
        )
        self.assertEqual(
            error_tensor.shape[0],
            self.batch_size,
            "Possible reason: error_tensor has been changed or the"
            "formula is not implemented correctly.",
        )
    ...
    def test_update(self):
        ...
        for _ in range(10):
            ...
            self.assertLess(
                np.sum(np.power(output_tensor, 2)),
    ...
    def test_gradient(self):
        ...
        self.assertLessEqual(
            np.sum(difference),
            1e-5,
            "Possible reason: Calculation of the gradient w.r.t. the input"
            "is incorrect.",
        )
    ...
    def test_gradient_weights(self):
        ...
        self.assertLessEqual(
            np.sum(difference),
            1e-5,
            "Possible reason: Calculation of the gradient w.r.t the weights"
            "is incorrect.",
        )
    ...
    def test_bias(self):
        ...
        self.assertGreater(
            np.sum(result),
            0,
            "Possible reason: Bias is not appended to the weights correctly, or in"
    ...
    def test_initialization(self):
        ...
        self.assertEqual(
            init.fan_in,
            input_size,
            "Possible reason: Shape of the weights is not correct, check their"
            "initialization.",
        )
        self.assertEqual(
            init.fan_out,
        ...
        if layer.weights.shape[0] > layer.weights.shape[1]:
            self.assertLessEqual(
                np.sum(layer.weights) - 17,
                1e-5,
                "Possible reason: Weights and/or bias is not"
                "initialized correctly, check their values.",
            )
        else:
            self.assertLessEqual(
                np.sum(layer.weights) - 35,
                1e-5,
                "Possible reason: Weights and/or bias is not"
                "initialized correctly, check their values.",
            )
...
class TestReLU(unittest.TestCase):
    ...
    def test_trainable(self):
        ...
        self.assertFalse(
            layer.trainable,
            "Possible reason: ReLU doesn't inherit from the base layer.",
        )
    ...
    def test_forward(self):
        ...
        output_tensor = layer.forward(self.input_tensor)
        self.assertEqual(
            np.sum(np.power(output_tensor - expected_tensor, 2)),
            0,
    ...
    def test_gradient(self):
        ...
        self.assertLessEqual(
            np.sum(difference),
            1e-5,
            "Possible reason: ReLU is not implemented correctly, check the"
...
class TestSoftMax(unittest.TestCase):
    ...
    def test_trainable(self):
        ...
        self.assertFalse(
            layer.trainable,
            "Possible reason: SoftMax doesn't inherit from the base layer.",
        )
    ...
    def test_forward_shift(self):
        ...
        self.assertFalse(
            np.isnan(np.sum(pred)),
            "Possible reason: Input tensor is not shifted by subtracting the max"
            "value.",
        )
    ...
    def test_forward_zero_loss(self):
        ...
        self.assertLess(
            loss,
            1e-10,
            "Possible reason: Formula for the forward method is not implemented correctly.",
        )
    ...
    def test_backward_zero_loss(self):
        ...
        self.assertAlmostEqual(
            np.sum(error),
            0,
            msg="Possible reason: Formula for the backward pass is not implemented"
            "correctly.",
        )
    ...
    def test_regression_high_loss(self):
        ...
        self.assertAlmostEqual(
            float(loss),
            12,
            msg="Possible reason: Formula for the forward pass is not implemented"
    ...
    def test_regression_backward_high_loss_w_CrossEntropy(self):
        ...
        for element in error[self.label_tensor == 0]:
            self.assertAlmostEqual(
                ...
                1 / 3,
                places=3,
                msg="Possible reason: Formula for SoftMax or"
    ...
    def test_regression_forward(self):
        ...
        self.assertGreater(
            float(loss),
            0.0,
            "Possible reason: You had very bad luck, try this test again. If it always"
    ...
    def test_regression_backward(self):
        ...
        for element in error[self.label_tensor == 0]:
            self.assertLessEqual(
                element,
                0,
                "Possible reason: Formula for SoftMax is not implemented correctly. Wrong"
                "predictions are not punished.",
            )
        ...
        for element in error[self.label_tensor == 1]:
            self.assertGreaterEqual(
                element,
                0,
                "Possible reason: Formula for SoftMax is not implemented correctly."
    ...
    def test_gradient(self):
        ...
        self.assertLessEqual(
            np.sum(difference),
            1e-5,
            "Possible reason: Forward or backward pass of SoftMax is not"
...
class TestCrossEntropyLoss(unittest.TestCase):
    ...
    def test_gradient(self):
        ...
        self.assertLessEqual(
            np.sum(difference),
            1e-4,
            "Possible reason: If only this fails, backward pass of CELoss is"
    ...
    def test_zero_loss(self):
        ...
        self.assertAlmostEqual(
            loss,
            0,
            msg="Possible reason: Forward pass of CELoss is not implemented correctly."
            "Check the formula again.",
        )
    ...
    def test_high_loss(self):
        ...
        self.assertAlmostEqual(
            ...
            324.3928805,
            places=4,
            msg="Possible reason: Forward pass of CELoss is not"
...
class TestOptimizers2(unittest.TestCase):
    ...
    def test_sgd_with_momentum(self):
        optimizer = Optimizers.SgdWithMomentum(1.0, 0.9)
    ...
    def test_adam(self):
        optimizer = Optimizers.Adam(1.0, 0.01, 0.02)
        ...
        result = optimizer.calculate_update(result, 0.5)
        np.testing.assert_almost_equal(
            result,
            np.array([-0.9814473195614205]),
...
class TestInitializers(unittest.TestCase):
    ...
    def test_uniform_shape(self):
        ...
        self.assertEqual(
            weights_shape,
            weights_after_init.shape,
            "Possible reason: Weights in uniform random are"
    ...
    def test_uniform_distribution(self):
        ...
        self.assertGreater(
            p_value,
            0.01,
            "Possible reason: Weights are not initialized correctly, make sure, that"
    ...
    def test_xavier_shape(self):
        ...
        self.assertEqual(
            weights_shape,
            weights_after_init.shape,
            "Possible reason: Weights in Xavier are initialized"
    ...
    def test_xavier_distribution(self):
        ...
        self.assertGreater(
            p_value,
            0.01,
            "Possible reason: Formula for Xavier initialization is not implemented"
            "correctly.",
        )
    ...
    def test_he_shape(self):
        ...
        self.assertEqual(
            weights_shape,
            weights_after_init.shape,
            "Possible reason: Weights in He are initialized in"
    ...
    def test_he_distribution(self):
        ...
        self.assertGreater(
            p_value,
            0.01,
            "Possible reason: Formula for He initialization is not implemented correctly",
        )
...
class TestFlatten(unittest.TestCase):
    ...
    def test_trainable(self):
        ...
        self.assertFalse(
            layer.trainable,
            "Possible reason: Flatten doesn't inherit from the base layer.",
        )
    ...
    def test_flatten_forward(self):
        ...
        self.assertLessEqual(
            np.sum(np.abs(output_tensor - input_vector)),
            1e-9,
    ...
    def test_flatten_backward(self):
        ...
        self.assertLessEqual(
            np.sum(np.abs(self.input_tensor - backward_tensor)),
            1e-9,
...
class TestConv(unittest.TestCase):
    ...
    def test_trainable(self):
        ...
        self.assertTrue(
            layer.trainable,
            "Possible reason: Convolutional Layer doesn't inherit the Base Layer and/or"
    ...
    def test_forward_size(self):
        ...
        self.assertEqual(
            output_tensor.shape,
            (self.batch_size, self.num_kernels, *self.input_shape[1:]),
    ...
    def test_forward_size_stride_uneven_image(self):
        ...
        input_tensor = np.array(
            range(int(np.prod(self.uneven_input_shape) * (self.batch_size + 1))),
            dtype=float,
        )
    ...
    def test_forward(self):
        ...
        conv.weights = (1.0 / 15.0) * np.array([[[1, 2, 1], [2, 3, 2], [1, 2, 1]]])
    ...
    def test_forward_multi_channel(self):
        ...
        filter = (1.0 / 15.0) * np.array([[[1, 2, 1], [2, 3, 2], [1, 2, 1]]])
        ...
        for map_i in range(maps_in):
            expected_output = expected_output + gaussian_filter(
                input_tensor[0, map_i, :, :],
                0.85,
                mode="constant",
                cval=0.0,
                truncate=1.0,
    ...
    def test_forward_fully_connected_channels(self):
        ...
        conv.weights = (1.0 / 15.0) * np.array(
            [
                [[1, 2, 1], [2, 3, 2], [1, 2, 1]],
                [[1, 2, 1], [2, 3, 2], [1, 2, 1]],
                [[1, 2, 1], [2, 3, 2], [1, 2, 1]],
        ...
        expected_output = 3 * gaussian_filter(
            input_tensor[0, 0, :, :], 0.85, mode="constant", cval=0.0, truncate=1.0
        )
        output_tensor = conv.forward(input_tensor).reshape((10, 14))
        difference = np.max(np.abs(expected_output - output_tensor))
        self.assertLess(
            difference,
            0.2,
            "Possible reason: If test_forward and/or test_forward_multi_channel fail as"
    ...
    def test_1D_forward_size(self):
        ...
        self.assertEqual(
            output_tensor.shape,
            (self.batch_size, self.num_kernels, 8),
    ...
    def test_layout_preservation(self):
        ...
        output_tensor = conv.forward(input_tensor)
        self.assertAlmostEqual(
            np.sum(np.abs(np.squeeze(output_tensor) - input_tensor[:, 1, :, :])),
            0.0,
    ...
    def test_initialization(self):
        ...
        self.assertEqual(
            init.fan_out,
            np.prod(self.kernel_shape[1:]) * self.num_kernels,
...
class TestPooling(unittest.TestCase):
    ...
    def setUp(self):
        ...
        np.random.seed(1337)
        self.input_tensor = np.random.uniform(
    ...
    def test_trainable(self):
        ...
        self.assertFalse(
            layer.trainable,
            "Possible reason: Pooling doesn't inherit from the base layer.",
        )
    ...
    def test_layout_preservation(self):
        ...
        self.assertAlmostEqual(
            np.sum(np.abs(output_tensor - input_tensor)),
            0.0,
    ...
    def test_expected_output_valid_edgecase(self):
        ...
        self.assertEqual(
            np.sum(np.abs(result - expected_result)),
            0,
...
class TestNeuralNetwork2(unittest.TestCase):
    ...
    def test_append_layer(self):
        ...
        self.assertEqual(
            len(net.layers),
            2,
            "Possible reason: append_layer method in NeuralNetwork doesn't actually"
            "append the layers.",
        )
        self.assertFalse(
            net.layers[0].optimizer is net.layers[1].optimizer,
            "Possible reason: The optimizer is not deepcopied, when a trainable layer is appended.",
        )
        self.assertTrue(
            np.all(net.layers[0].weights == 0.123),
    ...
    def test_iris_data(self):
        ...
        if TestNeuralNetwork2.plot:
            ...
            plt.plot(net.loss, "-x")
            fig.savefig(
                os.path.join(self.directory, "TestNeuralNetwork2.pdf"),
                transparent=True,
                bbox_inches="tight",
                pad_inches=0,
            )
    ...
    def test_iris_data_with_momentum(self):
        net = NeuralNetwork.NeuralNetwork(
            Optimizers.SgdWithMomentum(1e-3, 0.8),
            Initializers.UniformRandom(),
            Initializers.Constant(0.1),
        )
        categories = 3
        ...
        if TestNeuralNetwork2.plot:
            ...
            plt.plot(net.loss, "-x")
            fig.savefig(
                os.path.join(self.directory, "TestNeuralNetwork2_Momentum.pdf"),
                transparent=True,
                bbox_inches="tight",
                pad_inches=0,
            )
    ...
    def test_digit_data(self):
        net = NeuralNetwork.NeuralNetwork(
            Optimizers.Adam(5e-3, 0.98, 0.999),
            Initializers.He(),
            Initializers.Constant(0.1),
        )
        ...
        fcl_1 = FullyConnected.FullyConnected(
            fcl_1_input_size, int(fcl_1_input_size / 2.0)
        )
        net.append_layer(fcl_1)

        net.append_layer(ReLU.ReLU())

        fcl_2 = FullyConnected.FullyConnected(int(fcl_1_input_size / 2.0), categories)
        net.append_layer(fcl_2)
        ...
        if TestNeuralNetwork2.plot:
            ...
            plt.plot(net.loss, "-x")
            fig.savefig(
                os.path.join(self.directory, "TestConvNet_" + description + ".pdf"),
                transparent=True,
                bbox_inches="tight",
                pad_inches=0,
            )
    ...
    if sys.argv[-1] == "Bonus":
        ...
        for t, p in zip(tests, percentages):
            if (
                ...
                .run(loader.loadTestsFromTestCase(t))
                .wasSuccessful()
            ):
